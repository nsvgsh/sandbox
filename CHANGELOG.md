| AUTH-FLOW-0001 | Aligned client login flow with desired design; added tgUserId to allowlist; wired Telegram Login in Dev Choice; updated outside-Telegram behavior and error UI |
...
| UI-LEVELUP-0002 | Removed reward tiles bottom gap in LevelUp modal: pills stretch to row height; modal uses Telegram safe-area vars |

...
insert into game_config(key,value) values ('ingest','{}'::jsonb) on conflict (key) do update set value = coalesce(game_config.value,'{}'::jsonb) || jsonb_build_object('max_taps_per_batch', 50) || jsonb_build_object('clamp_soft', true);

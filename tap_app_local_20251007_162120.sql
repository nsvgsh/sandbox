...
\restrict 8EeSD28wqK9qwdhdfguZDvOkrJeSeVxGiiJoLa3BsruuNjR2Idlq8I7IKbgsgxg
...
ALTER TABLE IF EXISTS ONLY public.user_counters DROP CONSTRAINT IF EXISTS user_counters_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.telegram_identities DROP CONSTRAINT IF EXISTS telegram_identities_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_progress DROP CONSTRAINT IF EXISTS task_progress_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.task_progress DROP CONSTRAINT IF EXISTS task_progress_task_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tap_batches DROP CONSTRAINT IF EXISTS tap_batches_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reward_events DROP CONSTRAINT IF EXISTS reward_events_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.partner_postbacks DROP CONSTRAINT IF EXISTS partner_postbacks_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.level_events DROP CONSTRAINT IF EXISTS level_events_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.leaderboard_global DROP CONSTRAINT IF EXISTS leaderboard_global_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.attribution_leads DROP CONSTRAINT IF EXISTS attribution_leads_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ad_events DROP CONSTRAINT IF EXISTS ad_events_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.active_effects DROP CONSTRAINT IF EXISTS active_effects_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.active_effects DROP CONSTRAINT IF EXISTS active_effects_source_reward_event_id_fkey;
DROP INDEX IF EXISTS public.uq_level_reward_templates_active;
DROP INDEX IF EXISTS public.idx_telegram_identities_user;
DROP INDEX IF EXISTS public.idx_tap_batches_user_seq;
DROP INDEX IF EXISTS public.idx_tap_batches_user_created;
DROP INDEX IF EXISTS public.idx_partner_postbacks_user_provider_goal;
DROP INDEX IF EXISTS public.idx_level_events_user_created;
DROP INDEX IF EXISTS public.idx_leaderboard_level;
DROP INDEX IF EXISTS public.idx_ad_events_user_intent;
DROP INDEX IF EXISTS public.idx_ad_events_user_impression;
DROP INDEX IF EXISTS public.idx_ad_events_user_created;
DROP INDEX IF EXISTS public.idx_ad_events_impression;
ALTER TABLE IF EXISTS ONLY public.user_profiles DROP CONSTRAINT IF EXISTS user_profiles_pkey;
ALTER TABLE IF EXISTS ONLY public.user_counters DROP CONSTRAINT IF EXISTS user_counters_pkey;
ALTER TABLE IF EXISTS ONLY public.telegram_identities DROP CONSTRAINT IF EXISTS telegram_identities_pkey;
ALTER TABLE IF EXISTS ONLY public.task_progress DROP CONSTRAINT IF EXISTS task_progress_pkey;
ALTER TABLE IF EXISTS ONLY public.task_definitions DROP CONSTRAINT IF EXISTS task_definitions_pkey;
ALTER TABLE IF EXISTS ONLY public.tap_batches DROP CONSTRAINT IF EXISTS tap_batches_pkey;
ALTER TABLE IF EXISTS ONLY public.reward_events DROP CONSTRAINT IF EXISTS reward_events_pkey;
ALTER TABLE IF EXISTS ONLY public.partner_postbacks DROP CONSTRAINT IF EXISTS partner_postbacks_user_id_provider_goal_key;
ALTER TABLE IF EXISTS ONLY public.partner_postbacks DROP CONSTRAINT IF EXISTS partner_postbacks_pkey;
ALTER TABLE IF EXISTS ONLY public.level_reward_templates DROP CONSTRAINT IF EXISTS level_reward_templates_pkey;
ALTER TABLE IF EXISTS ONLY public.level_offer_schedule DROP CONSTRAINT IF EXISTS level_offer_schedule_task_id_key;
ALTER TABLE IF EXISTS ONLY public.level_offer_schedule DROP CONSTRAINT IF EXISTS level_offer_schedule_pkey;
ALTER TABLE IF EXISTS ONLY public.level_events DROP CONSTRAINT IF EXISTS level_events_pkey;
ALTER TABLE IF EXISTS ONLY public.leaderboard_global DROP CONSTRAINT IF EXISTS leaderboard_global_pkey;
ALTER TABLE IF EXISTS ONLY public.game_config DROP CONSTRAINT IF EXISTS game_config_pkey;
ALTER TABLE IF EXISTS ONLY public.dev_whitelist DROP CONSTRAINT IF EXISTS dev_whitelist_pkey;
ALTER TABLE IF EXISTS ONLY public.attribution_leads DROP CONSTRAINT IF EXISTS attribution_leads_pkey;
ALTER TABLE IF EXISTS ONLY public.ad_events DROP CONSTRAINT IF EXISTS ad_events_pkey;
ALTER TABLE IF EXISTS ONLY public.active_effects DROP CONSTRAINT IF EXISTS active_effects_user_id_type_source_reward_event_id_key;
ALTER TABLE IF EXISTS ONLY public.active_effects DROP CONSTRAINT IF EXISTS active_effects_pkey;
ALTER TABLE IF EXISTS public.partner_postbacks ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.level_events ALTER COLUMN id DROP DEFAULT;
DROP TABLE IF EXISTS public.user_profiles;
DROP TABLE IF EXISTS public.user_counters;
...
DROP TABLE IF EXISTS public.tap_batches;
DROP TABLE IF EXISTS public.reward_events;
DROP SEQUENCE IF EXISTS public.partner_postbacks_id_seq;
DROP TABLE IF EXISTS public.partner_postbacks;
DROP TABLE IF EXISTS public.level_reward_templates;
DROP TABLE IF EXISTS public.level_offer_schedule;
DROP SEQUENCE IF EXISTS public.level_events_id_seq;
DROP TABLE IF EXISTS public.level_events;
DROP TABLE IF EXISTS public.leaderboard_global;
DROP TABLE IF EXISTS public.game_config;
DROP TABLE IF EXISTS public.dev_whitelist;
DROP TABLE IF EXISTS public.attribution_leads;
DROP TABLE IF EXISTS public.ad_events;
DROP TABLE IF EXISTS public.active_effects;
DROP FUNCTION IF EXISTS public.session_start(p_user_id uuid);
DROP FUNCTION IF EXISTS public.claim_task_v2(p_user_id uuid, p_task_id uuid, p_idempotency_key uuid);
DROP FUNCTION IF EXISTS public.claim_task(p_user_id uuid, p_task_id uuid);
DROP FUNCTION IF EXISTS public.claim_level_bonus_v4(p_user_id uuid, p_level integer, p_bonus_multiplier numeric, p_idempotency_key uuid, p_impression_id uuid);
DROP FUNCTION IF EXISTS public.claim_level_bonus(p_user_id uuid, p_level integer, p_bonus_multiplier numeric, p_idempotency_key uuid);
DROP FUNCTION IF EXISTS public.apply_tap_batch(p_user_id uuid, p_batch_id uuid, p_session_id uuid, p_session_epoch uuid, p_client_seq bigint, p_taps integer, p_coins_delta bigint, p_checksum text);
DROP FUNCTION IF EXISTS public.apply_reward_event(p_user_id uuid, p_source_type text, p_source_ref text, p_base_payload jsonb, p_multiplier numeric);
DROP FUNCTION IF EXISTS public._threshold_for_level(p_level integer);
DROP FUNCTION IF EXISTS public._next_threshold(p_level integer);
...
COPY public.active_effects (effect_id, user_id, type, magnitude, expires_at, source_reward_event_id, created_at) FROM stdin;
\.
...
COPY public.ad_events (id, user_id, session_id, provider, placement, status, reward_payload, created_at) FROM stdin;
\.
...
COPY public.attribution_leads (user_id, campaign_id, first_seen_at, meta) FROM stdin;
\.
...
COPY public.dev_whitelist (tg_user_id, notes, created_at) FROM stdin;
\.
...
COPY public.game_config (key, value) FROM stdin;
...
COPY public.leaderboard_global (user_id, level, updated_at) FROM stdin;
33d054c2-1ced-461b-bfba-64ef19ad5744	2	2025-10-07 16:15:50.990178+03
\.
...
COPY public.level_events (id, user_id, level, base_reward, reward_payload, bonus_offered, bonus_multiplier, ad_event_id, created_at, template_id) FROM stdin;
1	33d054c2-1ced-461b-bfba-64ef19ad5744	1	0	{}	f	\N	\N	2025-10-07 16:15:45.065448+03	\N
2	33d054c2-1ced-461b-bfba-64ef19ad5744	2	0	{"coins": 0, "tickets": 25, "coin_multiplier": 1.28}	t	\N	\N	2025-10-07 16:15:48.315235+03	258d2862-6c62-4bdc-a164-c6175106d8e0
\.
...
COPY public.level_offer_schedule (level, active, skip_base_reward, partner_key, payload, updated_at, task_id) FROM stdin;
1	t	t	free_trial	{}	2025-10-07 16:15:23.731803+03	7d1ac119-00af-4ac6-be6a-e1488fba0a32
4	t	t	free_trial	{}	2025-10-07 16:15:23.731803+03	bd3b169c-ec35-4bf4-a5d1-ed2bc0d017e5
7	t	t	free_trial	{}	2025-10-07 16:15:23.731803+03	ab7db760-4be1-4534-ad3e-7b7fa02825cb
\.
...
COPY public.level_reward_templates (template_id, level, season_id, segment, active, payload, updated_at) FROM stdin;
d0d98652-d481-4225-b773-889dcff63a1b	1	\N	\N	t	{"coins": 0, "tickets": 11, "coin_multiplier": 1.21}	2025-10-07 16:15:23.731803+03
258d2862-6c62-4bdc-a164-c6175106d8e0	2	\N	\N	t	{"coins": 0, "tickets": 25, "coin_multiplier": 1.28}	2025-10-07 16:15:23.731803+03
4c3a7906-cef2-4bb7-89a9-fe55aae9a916	3	\N	\N	t	{"coins": 0, "tickets": 45, "coin_multiplier": 1.35}	2025-10-07 16:15:23.731803+03
b95b7553-5e93-44e7-b46b-3f71246aca48	4	\N	\N	t	{"coins": 0, "tickets": 69, "coin_multiplier": 1.42}	2025-10-07 16:15:23.731803+03
ce636db0-f9be-4abb-8ae3-730d29508039	5	\N	\N	t	{"coins": 0, "tickets": 99, "coin_multiplier": 1.49}	2025-10-07 16:15:23.731803+03
71fb6217-bc97-4926-aaf3-e79695310f9d	6	\N	\N	t	{"coins": 0, "tickets": 135, "coin_multiplier": 1.56}	2025-10-07 16:15:23.731803+03
d1c638e2-ca89-4ea3-9340-a9481059d158	7	\N	\N	t	{"coins": 0, "tickets": 175, "coin_multiplier": 1.56}	2025-10-07 16:15:23.731803+03
478e89fa-749f-4ba0-982b-6e8dba61bc7d	8	\N	\N	t	{"coins": 0, "tickets": 219, "coin_multiplier": 1.63}	2025-10-07 16:15:23.731803+03
d5ba0656-a4a8-4574-a77c-a42e2bbc8cac	9	\N	\N	t	{"coins": 0, "tickets": 267, "coin_multiplier": 1.7}	2025-10-07 16:15:23.731803+03
1c71fac4-fd41-4234-a280-689e498b4990	10	\N	\N	t	{"coins": 0, "tickets": 321, "coin_multiplier": 1.77}	2025-10-07 16:15:23.731803+03
6951e6b1-70fa-425e-b977-4620b9c20a0c	11	\N	\N	t	{"coins": 0, "tickets": 381, "coin_multiplier": 1.84}	2025-10-07 16:15:23.731803+03
2d89a478-7c79-4bca-877f-8db03f8c7172	12	\N	\N	t	{"coins": 0, "tickets": 429, "coin_multiplier": 1.91}	2025-10-07 16:15:23.731803+03
c26d805b-4ef3-4fec-a246-c09d0f78b07c	13	\N	\N	t	{"coins": 0, "tickets": 481, "coin_multiplier": 1.98}	2025-10-07 16:15:23.731803+03
7b4d7167-f04d-4562-8214-f04722fe3f93	14	\N	\N	t	{"coins": 0, "tickets": 541, "coin_multiplier": 2.05}	2025-10-07 16:15:23.731803+03
465437fb-a896-4ae8-b01a-638739723e47	15	\N	\N	t	{"coins": 0, "tickets": 609, "coin_multiplier": 2.12}	2025-10-07 16:15:23.731803+03
\.
...
COPY public.partner_postbacks (id, user_id, provider, subid, goal, url, status, http_code, response_hash, attempts, created_at, sent_at) FROM stdin;
\.
...
COPY public.reward_events (id, user_id, source_type, source_ref_id, base_payload, multiplier_applied, policy_key, effective_payload, coins_delta, tickets_delta, coin_multiplier_delta, status, idempotency_key, created_at) FROM stdin;
\.
...
COPY public.tap_batches (batch_id, user_id, session_id, client_seq, taps, coins_delta, checksum, status, error_code, created_at, applied_at) FROM stdin;
36ed6934-984c-417b-baa0-8dd16c296f5f	33d054c2-1ced-461b-bfba-64ef19ad5744	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	1	2	0	sha256:dev	applied	\N	2025-10-07 16:15:43.274429+03	\N
765e06cc-52ff-4434-9302-f9aabb799ff1	33d054c2-1ced-461b-bfba-64ef19ad5744	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	2	5	0	sha256:dev	applied	\N	2025-10-07 16:15:43.831739+03	\N
614ea6de-dd28-4094-9985-3185582726c7	33d054c2-1ced-461b-bfba-64ef19ad5744	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	3	4	0	sha256:dev	applied	\N	2025-10-07 16:15:44.432752+03	\N
b9422d76-993a-4a43-ba91-51dfe8022e8c	33d054c2-1ced-461b-bfba-64ef19ad5744	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	4	4	0	sha256:dev	applied	\N	2025-10-07 16:15:45.065448+03	\N
60a74b3a-9022-4c83-994e-f811cffa5509	33d054c2-1ced-461b-bfba-64ef19ad5744	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	5	1	0	sha256:dev	applied	\N	2025-10-07 16:15:45.713032+03	\N
b9a521c8-11e7-4292-8cca-3f38ef3e6308	33d054c2-1ced-461b-bfba-64ef19ad5744	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	6	2	0	sha256:dev	applied	\N	2025-10-07 16:15:47.004983+03	\N
4fab162c-6085-4a73-899c-3bed9e130eff	33d054c2-1ced-461b-bfba-64ef19ad5744	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	7	4	0	sha256:dev	applied	\N	2025-10-07 16:15:47.612725+03	\N
723b2937-f1fc-4ac6-9414-b0ef8196df6b	33d054c2-1ced-461b-bfba-64ef19ad5744	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	8	4	0	sha256:dev	applied	\N	2025-10-07 16:15:48.315235+03	\N
c1608715-af92-4c68-bd6d-ba0b74e9350c	33d054c2-1ced-461b-bfba-64ef19ad5744	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	9	2	0	sha256:dev	applied	\N	2025-10-07 16:15:50.389124+03	\N
3682b85d-aef9-4e18-8bbc-5a4d84dab69d	33d054c2-1ced-461b-bfba-64ef19ad5744	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	10	4	0	sha256:dev	applied	\N	2025-10-07 16:15:50.990178+03	\N
\.
...
COPY public.task_definitions (task_id, unlock_level, kind, reward_payload, verification, active, created_at) FROM stdin;
d2902150-9357-4f8e-bb57-0921d1ee034c	1	in_app	{"tickets": 2, "coin_multiplier": 1.21}	none	t	2025-10-07 16:15:23.731803+03
719ce2a5-092f-4836-bc7b-64beddeb8470	1	free-trial	{"tickets": 3, "coin_multiplier": 1.23}	none	t	2025-10-07 16:15:23.731803+03
b2e156d1-50f6-4a0a-882e-56c25925127e	1	in_app	{"tickets": 2, "coin_multiplier": 1.21}	none	t	2025-10-07 16:15:23.731803+03
feeaf6d4-e80f-4ed1-9e07-4191f574b666	2	in_app	{"tickets": 3, "coin_multiplier": 1.29}	none	t	2025-10-07 16:15:23.731803+03
0e9b2f82-2879-4a93-a30e-bf6f9a30f564	3	in_app	{"tickets": 4, "coin_multiplier": 1.37}	none	t	2025-10-07 16:15:23.731803+03
aaf10783-5bf3-4d9e-8b5f-608c2ecf4358	4	free-trial	{"tickets": 7, "coin_multiplier": 1.45}	none	t	2025-10-07 16:15:23.731803+03
662e1f18-b655-4701-9106-d02075ca8c14	5	in_app	{"tickets": 8, "coin_multiplier": 1.53}	none	t	2025-10-07 16:15:23.731803+03
7c5cc354-0065-4439-9286-f6af2c9d8173	6	in_app	{"tickets": 9, "coin_multiplier": 1.61}	none	t	2025-10-07 16:15:23.731803+03
6864dab3-77c4-4c42-865e-644ff8cd72db	7	free-trial	{"tickets": 12, "coin_multiplier": 1.59}	none	t	2025-10-07 16:15:23.731803+03
34f93117-b5ea-40e5-9afc-80eb05aa3419	8	in_app	{"tickets": 12, "coin_multiplier": 1.64}	none	t	2025-10-07 16:15:23.731803+03
892746dc-a74b-4856-b930-f8415e3772b0	9	in_app	{"tickets": 12, "coin_multiplier": 1.72}	none	t	2025-10-07 16:15:23.731803+03
a4c51428-a729-46f5-acf6-2c4bf0729ebc	10	in_app	{"tickets": 12, "coin_multiplier": 1.81}	none	t	2025-10-07 16:15:23.731803+03
ed32bc5e-9119-4afa-bfc2-128d75254590	11	in_app	{"tickets": 12, "coin_multiplier": 1.9}	none	t	2025-10-07 16:15:23.731803+03
9c96b4b0-8b75-429e-9624-d3cdc322fb62	12	in_app	{"tickets": 12, "coin_multiplier": 1.99}	none	t	2025-10-07 16:15:23.731803+03
37db64b3-c3a2-4f8d-b165-2e9cbf83e861	13	in_app	{"tickets": 12, "coin_multiplier": 2.09}	none	t	2025-10-07 16:15:23.731803+03
d77d227c-f88e-4f9f-9b09-d7f4fd0998f2	14	in_app	{"tickets": 12, "coin_multiplier": 2.19}	none	t	2025-10-07 16:15:23.731803+03
587b3029-1f15-4e8e-ba38-e7763238834c	15	in_app	{"tickets": 12, "coin_multiplier": 2.29}	none	t	2025-10-07 16:15:23.731803+03
\.
...
COPY public.task_progress (user_id, task_id, state, claimed_at) FROM stdin;
\.
...
COPY public.telegram_identities (tg_user_id, user_id, first_name, last_name, username, photo_url, created_at, updated_at) FROM stdin;
\.
...
COPY public.user_counters (user_id, coins, tickets, coin_multiplier, level, total_taps, session_epoch, current_session_id, last_applied_seq, updated_at, non_progress_coins) FROM stdin;
33d054c2-1ced-461b-bfba-64ef19ad5744	3368	25	1.2800	2	32	35080abd-ea47-404f-ae48-5633e4b4872b	32a192b7-27a8-4343-8ba2-5c8a486e4ef1	10	2025-10-07 16:15:50.990178+03	0
\.
...
COPY public.user_profiles (user_id, created_at, locale, attribution_campaign_id) FROM stdin;
33d054c2-1ced-461b-bfba-64ef19ad5744	2025-10-07 16:15:41.970017+03	\N	\N
\.
...
SELECT pg_catalog.setval('public.level_events_id_seq', 2, true);
...
\unrestrict 8EeSD28wqK9qwdhdfguZDvOkrJeSeVxGiiJoLa3BsruuNjR2Idlq8I7IKbgsgxg
